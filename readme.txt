...
- 📐 Gyroscope-based steering
- 🚀 Smooth and responsive controls
- 🎨 Simple and functional interface
- 🧪 Built as a course project with a focus on clean structure and logic
...
- **Graphics:** Android Canvas / OpenGL (if used)
...
1. Clone the repo:
   ```bash
   git clone https://github.com/your-username/gyrodrive.git
